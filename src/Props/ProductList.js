...
export default class ProductList extends Component {
    ...
    renderProduct = () => {
        const jsx = this.arrProduct.map((item, index) => {
            return <div className="col-4" key={index}><ProductItem product={item} /></div>
        });
        return jsx
    }
    render() {
        ...
        return (
            <div className="d-flex">
                <div className="left" style={{ width: '35%' }}>
                    <div style={{ marginTop: '400px', backgroundColor: 'red' }}><a>HOME</a></div>
                    <div><a>SHOP</a></div>
                </div>
                <div className="right" style={{ width: '62%' }}>
